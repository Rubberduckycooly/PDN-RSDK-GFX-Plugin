...
namespace PDNRSonicGFXLoader
{
    public class GraphicsImage : FileType
    {
        ...
        : base("Retro Engine Grapics Image (v1/Dreamcast ver)",         //Description
        FileTypeFlags.SupportsLoading | FileTypeFlags.SupportsSaving,   //Flags
        new String[] { ".gfx" }) { }                                    //FileType
        ...
        protected override Document OnLoad(Stream input)
        {
            try
            {
                gfx = new RSDKvRS.gfx(input,true); //Load our gfx file (see that file for details)
